...
void display() {
  ...
  colors[ImGuiCol_TitleBg]                = ImVec4(mandelColorB.r, mandelColorB.g, mandelColorB.b, 0.40f);
  colors[ImGuiCol_TitleBgActive]          = ImVec4(mandelColorB.r, mandelColorB.g, mandelColorB.b, 0.65f);
